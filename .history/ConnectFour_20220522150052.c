...
PyMODINIT_FUNC PyInit_cConnectFour() {
    ...
    PyVoiceType.tp_basicsize = sizeof(PyBoard);
    PyVoiceType.tp_dealloc=(destructor) PyBoard_dealloc;
    PyVoiceType.tp_flags=Py_TPFLAGS_DEFAULT;
    PyVoiceType.tp_doc="Voice o";
    ...
    PyModule_AddObject(m, "Voice", (PyObject *)&PyVoiceType); // Add Voice object
